...
WebUI.selectOptionByValue(findTestObject('FormFields/IntendedTermOfEnrollment'), 'tfa_1130', false)

WebUI.setText(findTestObject('FormFields/inputPhoneNumber'), '5555555555')

WebUI.click(findTestObject('FormFields/selectCountry'))

WebUI.selectOptionByValue(findTestObject('FormFields/selectCountry'), 'tfa_1395', false)
